...
export const MPS_DATA = [
    { id: 1, name: 'Hon. A. Silva', district: 'Colombo', party: 'Gov', attendance: 85, budget_used: 92, last_vote: 'Sim' },
    { id: 2, name: 'Hon. B. Perera', district: 'Gampaha', party: 'Opp', attendance: 45, budget_used: 30, last_vote: 'Não' },
    { id: 3, name: 'Hon. C. Wickramasinghe', district: 'Kandy', party: 'Gov', attendance: 90, budget_used: 88, last_vote: 'Sim' },
    { id: 4, name: 'Hon. D. Rajapaksa', district: 'Hambantota', party: 'Gov', attendance: 60, budget_used: 75, last_vote: 'Absent' },
    { id: 5, name: 'Hon. E. Fernando', district: 'Galle', party: 'Opp', attendance: 78, budget_used: 65, last_vote: 'Não' },
    { id: 6, name: 'Hon. F. Mohamed', district: 'Colombo', party: 'Opp', attendance: 92, budget_used: 95, last_vote: 'Não' },
    { id: 7, name: 'Hon. G. Kumar', district: 'Jaffna', party: 'Ind', attendance: 50, budget_used: 40, last_vote: 'Abstain' },
    { id: 8, name: 'Hon. H. Banda', district: 'Kurunegala', party: 'Gov', attendance: 95, budget_used: 100, last_vote: 'Sim' },
];
